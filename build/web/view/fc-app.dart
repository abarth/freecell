...
@CustomTag("fc-app")
class FcApp extends PolymerElement with ChangeNotifier  {
  @reflectable @observable Tableau get tableau => __$tableau; Tableau __$tableau; @reflectable set tableau(Tableau value) { __$tableau = notifyPropertyChange(#tableau, __$tableau, value); }
  @reflectable @observable String get boardForSolver => __$boardForSolver; String __$boardForSolver; @reflectable set boardForSolver(String value) { __$boardForSolver = notifyPropertyChange(#boardForSolver, __$boardForSolver, value); }
  @reflectable @observable String get boardId => __$boardId; String __$boardId; @reflectable set boardId(String value) { __$boardId = notifyPropertyChange(#boardId, __$boardId, value); }
  @reflectable @observable int get remainingCards => __$remainingCards; int __$remainingCards; @reflectable set remainingCards(int value) { __$remainingCards = notifyPropertyChange(#remainingCards, __$remainingCards, value); }
