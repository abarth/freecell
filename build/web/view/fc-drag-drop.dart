...
class FcDragDrop extends PolymerElement with ChangeNotifier  {
  @reflectable @observable bool get dragging => __$dragging; bool __$dragging = false; @reflectable set dragging(bool value) { __$dragging = notifyPropertyChange(#dragging, __$dragging, value); }
