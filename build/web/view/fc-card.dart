...
@CustomTag("fc-card")
class FcCard extends PolymerElement with ChangeNotifier  {
  @reflectable @published ViewCard get card => __$card; ViewCard __$card; @reflectable set card(ViewCard value) { __$card = notifyPropertyChange(#card, __$card, value); }
