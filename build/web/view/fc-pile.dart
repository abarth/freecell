...
@CustomTag("fc-pile")
class FcPile extends PolymerElement with ChangeNotifier  {
  @reflectable @published Pile get pile => __$pile; Pile __$pile; @reflectable set pile(Pile value) { __$pile = notifyPropertyChange(#pile, __$pile, value); }
